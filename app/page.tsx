...
export default function Home() {
  ...
  <nav aria-label="Page sections"><a href="#route">ROUTE</a><a href="#decisions">DECISIONS</a><a href="#places">SAVED PLACES</a><a href="#stays">STAYS</a><a href="#kamakura">KAMAKURA</a><a href="#principles">NOTES</a></nav>
  ...
  <footer className="site-footer"><a href="#top">↑ TOP</a><p>JAPAN · NOVEMBER 2026<br/>WORKING PLAN / NOT A CHECKLIST</p></footer>
</main> }
